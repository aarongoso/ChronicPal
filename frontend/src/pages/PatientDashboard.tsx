      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl shadow">
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="text-xs text-slate-400 mt-1">
                Generated by a baseline ML model. Not clinically validated.
              </p>
            </div>
          ...
          <p className="text-xs text-slate-400 mt-3">
            These insights are informational only and do not replace professional medical advice. The flare-up risk score is generated by a baseline machine learning model and is not clinically validated.
          </p>
        </div>
